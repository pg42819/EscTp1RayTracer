...
#include "simplify/c_intersect.h"
                      ...
                      size_t &geomID, size_t &primID)
{
    ...
    int geom_id = -1;
    int prim_id = -1;
    // TODO replace with regular triangles if we still want to do this
...
int main(int argc, char *argv[]) {
    ...
    if (ispc) {
        ...
        // flatten if needed
        flatten_scene(SceneMesh, &flat_triangles, &num_flat_triangles);
